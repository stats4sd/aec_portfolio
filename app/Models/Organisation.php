    ...
    */
    ...
    protected static function booted()
    {
        static::addGlobalScope('owned', function (Builder $builder) {
            ...
            // if the logged in user is the default Site Admin user account with ID 1, he is allowed see all organisations
            // Note: this is modified for BrowserShot as it use account support@stats4sd.org for authentication to generate page content for PDF file
            if (Auth::user()->id == 1) {
                return;
            }
